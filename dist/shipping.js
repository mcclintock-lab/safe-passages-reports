...
OverviewTab = (function(_super) {
  ...
  OverviewTab.prototype.render = function() {
    var context, convergence_warning, existingLength, hasConWarning, isCollection, length, lengthChange, lengthChangeClass, lengthIncreased, noLengthChange, overlapsRig, percentChange, rig, rigIntersections, rigs, _i, _len, _ref1;
    ...
    convergence_warning = this.recordSet('ShippingLaneReport', 'ConWarning').data.value;
    if ((convergence_warning != null ? convergence_warning.length : void 0) > 0) {
      hasConWarning = true;
    } else {
      hasConWarning = false;
    }
