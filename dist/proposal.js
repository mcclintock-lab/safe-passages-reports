...
ZoneWhalesTab = (function(_super) {
  ...
  ZoneWhalesTab.prototype.render = function() {
    var context, feature, record, sensitiveWhales, sightings, sightingsData, species, whaleSightings, _i, _j, _len, _len1;
    window.results = this.results;
