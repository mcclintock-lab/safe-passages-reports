...
ProposalEmissionsTab = (function(_super) {
  ...
  ProposalEmissionsTab.prototype.parseReductions = function(emissions) {
    var currRed, er, name, reductions, type, _i, _len;
    reductions = {};
...
ProposalOverviewTab = (function(_super) {
  ...
  ProposalOverviewTab.prototype.dependencies = ['ShippingLaneReport', 'ZoneSize'];

  ProposalOverviewTab.prototype.render = function() {
    var context, isCollection, length, zonesize;
    window.results = this.results;
  ...
  ProposalOverviewTab.prototype._handleReportLayerClick = function(e) {
    var node, url;
    e.preventDefault();
    url = $(e.target).attr('href');
    node = window.app.projecthomepage.dataSidebar.layerTree.getNodeByUrl(url);
  ...
  ProposalOverviewTab.prototype.onMoreResultsClick = function(e) {
    if (e != null) {
      if (typeof e.preventDefault === "function") {
        e.preventDefault();
      }
